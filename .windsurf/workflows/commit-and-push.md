...
- [message] should be concise, plain english bullet points of major changes, 1 per line surrounded in "" using normal lines so I can read it. Dont use special characters or \n or -m for new line, just use normal new lines
